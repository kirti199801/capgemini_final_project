...
public class UserProfileService {
    ...
    public UserProfile addNewUserProfile(UserProfile userProfile) throws CustomException {
    	Optional<UserProfile> byEmail = userProfileRepository.findByEmail(userProfile.getEmail());
    	if(byEmail.isPresent()) {
    	throw new CustomException("useralreadyExits");
    	}
    ...
    public UserProfile login(AuthenticationRequest authenticationRequest) throws CustomException {
        ...
        //we are providing encoder if it matches then it will go for process 
